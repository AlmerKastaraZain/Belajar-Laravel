    ...
    <x-header>
        ...
        <x-text-header-1>Register User</x-text-header-1>
    
        <form method="POST" action="{{ route('register') }}" class="outline box-border px-10 py-6 outline-slate-900 rounded outline-1 bg-slate-100 shadow-lg dark:bg-slate-800">
            @csrf
            <div class="mb-3">
            ...
            <div>
                ...
                <input name="password_confirmation" type="password" placeholder="Confirm Password" id="default-input" class="
            ...
            <div>
                <button type="submit" class="mt-4 bg-blue-500 px-10 py-2 rounded font-bold text-white shadow-md hover:bg-blue-700 transition-colors">Create User</button>
            </div>
        </form>
        </div>
